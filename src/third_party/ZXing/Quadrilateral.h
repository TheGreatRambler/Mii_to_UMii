...
namespace ZXing {
	...
	public:
		...
		inline constexpr Point topLeft () const noexcept {
			return at (0);
		}
		inline constexpr Point topRight () const noexcept {
			return at (1);
		}
		inline constexpr Point bottomRight () const noexcept {
			return at (2);
		}
		inline constexpr Point bottomLeft () const noexcept {
			return at (3);
		}
